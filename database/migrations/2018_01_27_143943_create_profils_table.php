...
class CreateProfilsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('das_profil', function (Blueprint $table) {
            ...
            $table->string('kasie_pemerintahan_dan_pelum', 150)->nullable(true);
            $table->string('kasie_kesejahteraan_masyarakat', 150)->nullable(true);
            $table->string('kasie_ekonomi_dan_pembangunan', 150)->nullable(true);
            $table->string('kasie_trantib', 150)->nullable(true);
            $table->string('kasubag_kepegawaian', 150)->nullable(true);
            $table->string('kasubag_perencanaan_dan_keuangan', 150)->nullable(true);
